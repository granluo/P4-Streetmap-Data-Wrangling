...
expected = ["Santa Clara","San Jose","Sunnyvale","Saratoga",'Mountain View','Alviso','Campbell','Cupertino','Felton','Los Gatos','Milpitas','Moffett Field','Morgan Hill','Mt Hamilton']
# UPDATE THIS VARIABLE


mapping = { "SUnnyvale": "Sunnyvale",
